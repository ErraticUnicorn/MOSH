    ...
    public static class SaveManager
    {
        ...
        public static bool saveGame(string fileName, SaveGameData saveGame, bool encrypt=true)
        {
            ...
            try
            {
                ...
                if (!encrypt)
                {
                    Stream fStream = new FileStream(SAVE_DIRECTORY + fileName, FileMode.Create);
                ...
                else
                {
                    ...
                    encryptFile(memStream, SAVE_DIRECTORY + fileName);
                    memStream.Close();
                }
            }
            catch (Exception e)
        ...
        public static List<SaveGameData> loadAllGames()
        {
            ...
            if (Directory.Exists(SAVE_DIRECTORY))
            {
                string[] files = Directory.GetFiles(SAVE_DIRECTORY);
