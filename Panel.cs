...
namespace SunsetHigh
{
    ...
    public abstract class Panel : PopInOutSprite
    {
        ...
        public override void loadContent(ContentManager content)
        {
            ...
            this.loadImage(content, "InGameMenuBackground");
        ...
        private class BorderSystem
        {
            ...
            {
                this.horizontal = content.Load<Texture2D>("InGameMenuBorderHorizontal");
                this.vertical = content.Load<Texture2D>("InGameMenuBorderVertical");
                this.corner = content.Load<Texture2D>("InGameMenuCorner");
            }
